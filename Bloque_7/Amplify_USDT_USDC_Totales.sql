select 
    'total_USDC' as stablecoin_type,
    CASE 
        WHEN t.contract_address = 0x3c499c542cef5e3811e1192ce70d8cc03d5c3359 
            THEN SUM(t.value/POWER(10,e.decimals)) END as total_amount
from
...
and 
    t.contract_address in (0x3c499c542cef5e3811e1192ce70d8cc03d5c3359)
group by 
    t.contract_address
...
where 
    t.to = 0xfc4fc27c278e9ea16030fc4f7f9d2ac511d1c1f8
and 
    t.contract_address in (0xc2132d05d31c914a87c6611c10748aeb04b58e8f)
group by 
    t.contract_address
