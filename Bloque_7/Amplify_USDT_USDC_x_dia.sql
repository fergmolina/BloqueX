select 
    ...
    CASE 
        WHEN t.contract_address = 0x3c499c542cef5e3811e1192ce70d8cc03d5c3359 
            THEN SUM(t.value/POWER(10,e.decimals)) END as total_USDC,
    CASE 
        WHEN t.contract_address = 0xc2132d05d31c914a87c6611c10748aeb04b58e8f 
            THEN SUM(t.value/POWER(10,e.decimals)) END as total_USDT
from
...
group by 
        date_trunc('day', evt_block_time), t.contract_address